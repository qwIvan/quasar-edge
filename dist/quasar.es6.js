...
var ContextMenuDesktop = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('q-popover',{ref:"popover",attrs:{"anchor-click":false}},[_vm._t("default")],2)},staticRenderFns: [],
  props: {
    disable: Boolean
  },
  methods: {
...
var ContextMenuMobile = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('q-modal',{ref:"dialog",staticClass:"minimized"},[_vm._t("default")],2)},staticRenderFns: [],
  props: {
    disable: Boolean
  },
  methods: {
...
var TablePagination = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"q-data-table-toolbar bottom-toolbar row reverse-wrap items-baseline justify-end"},[_c('div',[_vm._v("Rows"),_c('q-select',{directives:[{name:"model",rawName:"v-model",value:(_vm.pagination.rowsPerPage),expression:"pagination.rowsPerPage"}],staticClass:"text-right",attrs:{"type":"radio","options":_vm.pagination.options},domProps:{"value":(_vm.pagination.rowsPerPage)},on:{"input":[function($event){_vm.pagination.rowsPerPage=$event;},_vm.resetPage]}})],1),(_vm.entries > 0)?_c('div',[_vm._v(_vm._s(_vm.start)+" - "+_vm._s(_vm.end)+" / "+_vm._s(_vm.entries))]):_vm._e(),(_vm.pagination.rowsPerPage > 0)?_c('q-pagination',{directives:[{name:"model",rawName:"v-model",value:(_vm.pagination.page),expression:"pagination.page"}],attrs:{"max":_vm.max},domProps:{"value":(_vm.pagination.page)},on:{"input":function($event){_vm.pagination.page=$event;}}}):_vm._e()],1)},staticRenderFns: [],
...
var SmallFab = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('button',{staticClass:"circular small raised",on:{"click":function($event){_vm.$parent.close();}}},[_c('i',[_vm._v(_vm._s(_vm.icon))]),_vm._t("default")],2)},staticRenderFns: [],
  props: {
    icon: {
      type: String,
      required: true
...
var ToolbarTitle = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"toolbar-content"},[_c('div',{staticClass:"toolbar-title",class:['padding-' + _vm.padding]},[_c('div',[_vm._t("default")],2)])])},staticRenderFns: [],
  props: {
    padding: {
      type: Number,
      default: 1
...
var Modal = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('transition',{attrs:{"name":_vm.transition}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.active),expression:"active"}],staticClass:"modal fullscreen flex",class:_vm.positionClasses,on:{"click":function($event){_vm.click();}}},[_c('div',{ref:"content",staticClass:"modal-content",style:(_vm.contentCss),on:{"click":function($event){$event.stopPropagation();}}},[_vm._t("default")],2)])])},staticRenderFns: [],
  props: {
    transition: {
      type: String,
      default: 'q-modal'
...
var Popover = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"q-popover animate-scale",style:(_vm.transformCSS),on:{"click":function($event){$event.stopPropagation();}}},[_vm._t("default")],2)},staticRenderFns: [],
  props: {
    anchor: {
      type: String,
      default: 'bottom left',
...
var State = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('span',[(_vm.active)?_vm._t("active"):_vm._t("default")],2)},staticRenderFns: [],
  props: {
    active: {
      type: Boolean,
      required: true
...
var Stepper = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"q-stepper timeline primary"},[_vm._t("default")],2)},staticRenderFns: [],
  props: {
    backLabel: {
      type: String,
      default: 'Back'
...
var Tab = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return (_vm.route)?_c('router-link',{ref:"routerLink",staticClass:"q-tab items-center justify-center",class:{ active: _vm.isActive, hidden: _vm.hidden, disabled: _vm.disable, hideIcon: _vm.hide === 'icon', hideLabel: _vm.hide === 'label' },attrs:{"to":_vm.route,"replace":_vm.replace,"append":_vm.append,"exact":_vm.exact,"tag":"div"},on:{"click":function($event){$event.stopPropagation();$event.preventDefault();_vm.activate();}}},[(_vm.icon)?_c('i',{staticClass:"q-tabs-icon"},[_vm._v(_vm._s(_vm.icon))]):_vm._e(),_vm._v(" "),_c('span',{staticClass:"q-tab-label"},[_vm._t("default")],2)]):_c('div',{staticClass:"q-tab items-center justify-center",class:{ active: _vm.isActive, hidden: _vm.hidden, disabled: _vm.disable, hideIcon: _vm.hide === 'icon', hideLabel: _vm.hide === 'label' },on:{"click":function($event){_vm.activate();}}},[(_vm.icon)?_c('i',{staticClass:"q-tabs-icon"},[_vm._v(_vm._s(_vm.icon))]):_vm._e(),_vm._v(" "),_c('span',{staticClass:"q-tab-label"},[_vm._t("default")],2)])},staticRenderFns: [],
  props: {
    label: String,
    icon: String,
    disable: Boolean,
...
var Tooltip = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('span',{staticClass:"q-tooltip animate-scale",style:(_vm.transformCSS)},[_vm._t("default")],2)},staticRenderFns: [],
  props: {
    anchor: {
      type: String,
      default: 'top middle',
...
var Video = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"video"},[_c('iframe',{attrs:{"src":_vm.src,"frameborder":"0","allowfullscreen":""}})],1)},staticRenderFns: [],
  props: ['src']
};
